var store = [{
        ...
        "tags": ["Blog","Github","Github Pages","Error"],
        "url": "/blog/blog-TIL/",
        "teaser": "/assets/images/github-pages.png"
      },{
        "title": "[BOJ] 백준 18185번 - 라면 사기 (Small) (Python)",
        "excerpt":"문제 문제 바로가기 “이게 정답률 29%?” 애초부터 그리디 필수 문제집에서 뽑은 문제고, 문제도 딱 봐도 그리디이다. 되게 쉬운 것 같았는데… 라면을 연속된 공장 3개에서 하나씩 총 3개를 구입하면 7원 라면을 연속된 공장 2개에서 하나씩 총 2개를 구입하면 5원 라면을 연속된 공장 1개에서 하나씩 총 1개를 구입하면 3원 붙어있는 공장들 중...","categories": ["BOJ"],
        "tags": ["BOJ","Greedy","Python"],
        "url": "/boj/boj-18185/",
        "teaser": "/assets/images/teaser.png"
      },{
        "title": "[BOJ] 백준 2212번 - 센서 (Python)",
        "excerpt":"문제 문제 바로가기 N개의 센서가 있고, 리스트의 값들은 원점으로부터 각각의 센서가 얼마나 거리에 있는 지 나타낸다. K개의 집중국은 K개의 가장 밀집된 클러스터에 배정되어 수신 가능 영역의 길이의 합이 최소가 되도록 해야한다. 문제 해결 집중국을 어디에 위치하는 것은 중요한 게 아니고, 각각의 집중국의 수신 가능 영역의 길이의 합만 구하면 되기 때문에...","categories": ["BOJ"],
        "tags": ["BOJ","Greedy","Python"],
        "url": "/boj/boj-2212/",
        "teaser": "/assets/images/teaser.png"
      },{
        ...
        "tags": ["Stack","Recursive","Python"],
        "url": "/datastructure/DS-stack/",
        "teaser": "/assets/images/teaser.png"
      },{
        "title": "[알고리즘] 탐색 알고리즘 DFS/BFS",
        "excerpt":"Graph   DFS, BFS를 설명하기 전에 Graph의 기본 구조를 알아야 한다.   해당 내용은 자세히 포스팅 해놓았으니 다음 링크를 클릭하자 !   [자료구조] 그래프(Graph)란   DFS      DFS는 Depth-First Search, 깊이 우선 탐색이라고도 부르며, 그래프에서 깊은 부분을 우선적으로 탐색하는 알고리즘이다.   ","categories": ["Algorithm"],
        "tags": ["DFS","BFS","Recursive","Stack","Queue","Python"],
        ...
        "tags": ["BOJ","Graph","BFS","Python"],
        "url": "/boj/boj-2178/",
        "teaser": "/assets/images/teaser.png"
      },{
        "title": "[BOJ] 백준 14502번 - 연구소 (Python)",
        "excerpt":"문제 문제 바로가기 from collections import deque from itertools import combinations import copy move_y = [0, 1, 0, -1] move_x = [1, 0, -1, 0] def infect(graph, virus): q = deque() for v in virus: q.append(v) while q: y, x = q.popleft() for i in range(4): vy = y +...","categories": ["BOJ"],
        "tags": ["BOJ","Implementation","BFS","Brute Force","Python"],
        "url": "/boj/boj-14502/",
        "teaser": "/assets/images/teaser.png"
      },{
        ...
        "title": "[알고리즘] 정렬 알고리즘",
        "excerpt":"정렬 (Sorting) 정렬(Sorting)이란 데이터를 특정한 기준에 따라서 순서대로 나열하는 것을 말한다. 프로그램에서 데이터를 가공할 때 오름차순이나 내림차순 등 어떤 식으로든 정렬해서 사용하는 경우가 많아 정렬 알고리즘은 필수적으로 알아야한다고 할 수 있다. 정렬 알고리즘은 선택 정렬, 삽입 정렬, 퀵 정렬 등등 다양한 알고리즘이 존재하는데, 상황에 적절하지 못한 정렬 알고리즘을 사용할 경우...","categories": ["Algorithm"],
        "tags": ["Sort","Python"],
        "url": "/algorithm/alg-sort/",
        "teaser": "/assets/images/ALG-sort.png"
      },{
        "title": "[BOJ] 백준 1789번 - 수들의 합 (Python)",
        "excerpt":"문제 문제 바로가기 해결 딱 봐도 작은 자연수부터 더하는 그리디 알고리즘인 것을 눈치챘다. 우선 예제인 200을 1부터 차근차근 더하다보니 1 + 2 + 3 + 4 + ... + 19임을 알았고 그럼 201은 어떨까 생각해보면 1 + 2 + 3 + 4 + ... + 19과 동일하지만 마지막만 19가 아니라...","categories": ["BOJ"],
        "tags": ["BOJ","Greedy","Python"],
        "url": "/boj/boj-1789/",
        "teaser": "/assets/images/teaser.png"
      },{
        "title": "[BOJ] 백준 2667번 - 단지번호 붙이기 (Python)",
        "excerpt":"문제 문제 바로가기 해결 문제를 보면 직관적으로 풀이 방법이 떠오른다. 그래프에서 ‘1’인 곳의 인덱스를 찾는다. BFS/DFS를 사용하여 연속된 ‘1’을 탐색해나가며 ‘1’을 다른 임의의 값으로 바꾸어가며 카운트를 센다. 카운트가 끝나면 아파트 단지 리스트에 카운트(집의 개수)를 추가한다. 1번에서 ‘1’인 곳이 존재하지 않을 때까지 반복한다. 첫 번째 제출 파이썬으로 작성한 첫 번째 제출답안은...","categories": ["BOJ"],
        "tags": ["BOJ","Graph","BFS","Python"],
        "url": "/boj/boj-2667/",
        "teaser": "/assets/images/teaser.png"
      }]
